...
<head>
    ...
    <title>Universitas Indraprasta PGRI - Portal Akademik</title>
                ...
                <div class="flex-container">
                    <div class="hero-content">
                        ...
                        <p class="hero-description">
                            Portal informasi akademik terlengkap untuk civitas akademika Universitas Indraprasta PGRI.
                            <br>
                            ...
                            <svg class="animated-blob" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                                <defs>
                                    <linearGradient id="gradient" x1="0%" y1="0%" x2="0%" y2="100%">
                                        <stop offset="40%" style="stop-color: #8bd2f2"></stop>
                                        <stop offset="60%" style="stop-color: #47B0E0FF"></stop>
                                    </linearGradient>
                                </defs>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            var typed = new Typed('#typed', {
                strings: ['Akademik', 'Universitas Indraprasta PGRI', 'Kampus'],
                typeSpeed: 50,
                backSpeed: 50,
                loop: true
            });
