...
$attendance_today = $overview_data['attendance_today'] ?? 3;
$assignment_completion = $overview_data['assignment_completion'] ?? 15;
$grades_input = $overview_data['grades_input'] ?? 12;
$active_schedule = $overview_data['active_schedule'] ?? 15;
...
if (count($recent_activities) < 4) {
    $system_activities = [
        ...
        ['action' => 'Portal akademik online', 'user' => 'Universitas Indraprasta PGRI', 'time' => '15 menit yang lalu'],
...
<head>
    ...
    <title>Dashboard Admin - Universitas Indraprasta PGRI</title>
