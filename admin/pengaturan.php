                    ...
                    <form method="POST" class="settings-form">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="url" id="site_url" name="site_url" class="form-control" value="https://unindra.ac.id" required>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="email" id="admin_email" name="admin_email" class="form-control" value="admin@unindra.ac.id" required>
                            </div>
                            <div class="form-group">
