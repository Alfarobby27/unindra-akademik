...
<head>
    ...
    <title>Profil Universitas - Universitas Indraprasta PGRI</title>
    ...
    <main>
        <div class="container">
            <div class="text-center mb-4">
                <img src="assets/img/logo.png" alt="Universitas Indraprasta PGRI Logo" class="school-logo">
                <h1 class="mt-3">Universitas Indraprasta PGRI</h1>
            ...
            <div>
                ...
                <p class="hero-description">
                    Universitas Indraprasta PGRI, atau biasa disebut dengan Unindra adalah salah satu Universitas swasta yang didirikan pada tahun 2004 dan disahkan kembali oleh Menteri Pendidikan Nasional RI melalui keputusan No : 142/D/0/2004 Tanggal 6 SEPTEMBER 2004. Tanggal resmi tersebut adalah pengakuan pemerintah atas berdirinya Universitas Indraprasta PGRI, dan tanggal tersebut dinyatakan sebagai hari lahir (DIES NATALIS ).
                </p>
                <p class="hero-description">
                    Unindra juga menjadi salah satu kampus perguruan tinggi dengan biaya kuliah yang terjangkau, terbukti dari penghargaan yang diberikan langsung oleh Gubernur DKI Jakarta yaitu Bapak Anies Baswedan dan Universitas Indraprasta PGRI hadir dengan moto Peduli, Mandiri, Kreatif dan Adaptif.
                </p>
                
                <h4 class="mt-4 text-primary">Visi</h4>
                <p class="hero-description">
                    Pada tahun 2029, Universitas Indraprasta PGRI menjadi Universitas yang unggul dalam pembelajaran (Excellent Teaching University) di Indonesia yang berperan aktif dalam pengembangan sumber daya manusia profesional yang peduli, kreatif, mandiri dan adaptif
                </p>
                
                <h4 class="mt-4 text-primary">Misi</h4>
                <ul class="hero-description">
                    <li>
                      Menyelenggarakan pendidikan dan pengajaran yang profesional sesuai dengan perkembangan ilmu pengetahuan, teknologi dan seni.
                    </li>
                    <li>
                ...
                <h4 class="mt-4 text-primary">Tujuan</h4>
                <ul class="hero-description">
                    <li>
                      Menghasilkan lulusan bermutu, profesional, berjiwa kewirausahaan, serta memiliki kompetensi tinggi dalam penguasaan ilmu pengetahuan dan teknologi sesuai dengan tuntutan masyarakat lokal, nasional, dan internasional.
                    </li>
                    <li>
                      Menghasilkan tenaga yang profesional dalam berbagai bidang yang dilandasi watak peduli, kreatif, mandiri, dan adaptif di Indonesia.
                    </li>
                    <li>
                      Menghasilkan karya-karya dan kajian yang mendukung pengembangan ilmu pengetahuan dan teknologi serta seni.
                    </li>
                    <li>
                      Menghasilkan solusi pemecahan masalah yang dihadapi masyarakat dan menambah jejaring.
                    </li>
                </ul>
            ...
            <div class="text-center mt-5 pt-4 border-top" style="max-width: 600px; margin: 0 auto;">
              <p>
                Kampus A: <br>
                <a href="https://maps.app.goo.gl/NkFiUUYKo2X2scPFA" style="color: black; text-decoration: none;">
                  Jl. Nangka Raya No.58 C, RT.7/RW.5, Tj. Bar., Kec. Jagakarsa,<br>
                  Kota Jakarta Selatan, DKI Jakarta 12530
                </a>
              </p>
              <p>
                Kampus B: <br>
                <a href="https://maps.app.goo.gl/cYaw6LYwXB3fUxUY8" style="color: black; text-decoration: none;">
                  Jl. Raya Tengah No.80, RT.6/RW.1, Gedong, Kec. Ps. Rebo,<br>
                  Kota Jakarta Timur, DKI Jakarta 13760
                </a>
              </p>
              <p>Telp: (021) 1234-5678 | Email: <a href="mailto:info@unindra.ac.id" style="color: black; text-decoration: none;">info@unindra.ac.id</a></p>
            </div>
